        ...
        <transition name="fade-swap" mode="out-in">
          ...
          <form v-else key="form" @submit.prevent="handleSubmit" class="contact-form" novalidate>
            ...
            <div class="form-group">
              ...
              <input id="c-name" type="text" v-model="form.name" :class="{ 'has-error': errors.name }"
            ...
            <div class="form-group">
              ...
              <input id="c-phone" type="tel" v-model="form.phone" :class="{ 'has-error': errors.phone }"
            ...
            <div class="form-group">
              ...
              <textarea id="c-message" v-model="form.message" rows="4" :class="{ 'has-error': errors.message }"
...
/* Trust items use the top-level trust.* keys from en.json */
const trustItems = [
  'trust.item1',
  'trust.item2',
  'trust.item3',
...
const validateField = (field) => {
  if (field === 'name') errors.name = form.name.trim().length < 2 ? t('contact.errors.name') : ''
  if (field === 'phone') errors.phone = !PHONE_RE.test(form.phone.trim()) ? t('contact.errors.phone') : ''
  if (field === 'message') errors.message = form.message.trim().length < 10 ? t('contact.errors.message') : ''
}
...
.success-icon {
  ...
  border: 1.5px solid rgba(204, 147, 58, 0.40);
  display: flex;
  align-items: center;
  justify-content: center;
  margin-bottom: 18px;
